...
my(root).on([fx.start, fx.move, fx.end].join(' '), function (e) {
	...
	var rect = canvasPriv.getBoundingClientRect();
	var sx = canvasPriv.scrollWidth / canvasPriv.width || 1;
	var sy = canvasPriv.scrollHeight / canvasPriv.height || 1;
...
my.extend(Image.prototype, {
    ...
    error: function (e) {
        return my(this).on('error', c), this
    }
})
...
ellipse:function(c,t,e,i,n,o,r){context2d.ellipse(c,t,e,i,getradi(n),getradi(o),deflt(r,!1))},
